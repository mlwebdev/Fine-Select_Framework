...
(function (
  ...
  evts,             // element.eventListener(type, function, bubble/true-false)
  log,              // console.log("")
  ...
  }, this.qSel = function(a) {
    return document.querySelector(a)
  }, this.createEl = function(a) {
    return document.createElement(a)
  }, this.evts = function evts(evt, evtType, func, bubl) {
    return evt.addEventListener(evtType, func, bubl);
